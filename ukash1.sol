...
/**
 * @title UKASH
 * @dev Token representing UKASH.
 */
contract UKASH is BurnableToken {
  ...
  */
  constructor(address wallet) public {
    owner = wallet;
    totalSupply = uint(10000000000).mul(10 ** uint256(decimals)); //Update total supply with the decimal amount
    name = "UKASH";
    symbol = "UKASH";
